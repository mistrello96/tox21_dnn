...
\todo[inline]{Io qua suddividerei in 3 parti, non per forza sotto sezioni (perdiamo spazio ;) ma almeno paragrafi: la parte di esplorazione iniziale, ottimizzazione iperparametri e analisi finali. Nei risultati uso dei paragrafi, perché perdo già spazio per le immaigni. DP}