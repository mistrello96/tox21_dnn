...
In aggiunta, in Figura \ref{subfig:auc-iteration} è riportato il valore di AUC (Area Under Curve) media ottenuto con l'\textit{i}-esima configurazione durante il processo di ottimizzazione.
\newpage
\begin{figure}[!h]
	\begin{tabular}{cc}
